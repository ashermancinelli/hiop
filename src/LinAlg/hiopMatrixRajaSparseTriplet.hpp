 ...
 */
class hiopMatrixRajaSparseTriplet : public hiopMatrix
{
public:
  hiopMatrixRajaSparseTriplet(int rows, int cols, int nnz);
  virtual ~hiopMatrixRajaSparseTriplet(); 

  virtual void setToZero();
  virtual void setToConstant(double c);
  virtual void copyFrom(const hiopMatrixRajaSparseTriplet& dm);
  ...
  virtual void addMDinvNtransToSymDeMatUTri(int row_dest_start, int col_dest_start, const double& alpha,
					    const hiopVectorPar& D, const hiopMatrixRajaSparseTriplet& N,
...
{
public: 
  hiopMatrixRajaSymSparseTriplet(int n, int nnz)
    : hiopMatrixRajaSparseTriplet(n, n, nnz)
  {
  }
